...
const successFactors = [
  ...
  { icon: ic(<><path d="M12 3v9l6.5 6.5A9 9 0 1012 3z" /><path d="M12 3a9 9 0 016.5 15.5" opacity="0.4" /></>), title: "AOV &", titleAccent: "Ecommerce Reality", desc: "High-AOV stores reach profitability faster and hold ROAS more easily. Under ~30 EUR / order, scaling gets harder — strong margins become a major advantage." },
];
const pillars = [
